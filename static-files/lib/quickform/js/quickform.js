...
qf.Validator.prototype = {
    ...
    onFieldError: function(elementId, errorMessage)
    {
		...
		qf.classes.remove(parent, this.classes.valid);
        var error = jQuery(".frm-error[rel="+elementId+"]");//.addClass(this.classes.message);
    ...
    onFieldValid: function(elementId)
    {
        ...
        if (ancestor) {
			...
			qf.classes.remove(ancestor, this.classes.error);
        } 
    },
